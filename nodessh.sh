...
ADMIN_USER=$(/opt/chefdk/embedded/bin/ruby -e "require '${SCRIPT_DIR}/lib/cluster_data';require '${SCRIPT_DIR}/lib/chef_node'; include BACH::ClusterData; include BACH::ClusterData::ChefNode; puts admin_user")
