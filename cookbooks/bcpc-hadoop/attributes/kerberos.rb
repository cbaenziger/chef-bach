...
default[:bcpc][:hadoop][:kerberos][:data] = {
  namenode: { 'principal' => 'nn',
              'keytab' => 'nn.service.keytab',
              'owner' => 'hdfs',
              'princhost' => '_HOST',
              'perms' => '0600',
              'spnego_keytab' => 'nn.service.keytab' },
  datanode: { 'principal' => 'dn',
              'keytab' => 'dn.service.keytab',
              'owner' => 'hdfs',
              'princhost' => '_HOST',
              'perms' => '0600',
              'spnego_keytab' => 'dn.service.keytab' },
  journalnode: { 'principal' => 'jn',
                 'keytab' => 'jn.service.keytab',
                 'owner' => 'hdfs',
                 'princhost' => '_HOST',
                 'perms' => '0600',
                 'spnego_keytab' => 'jn.service.keytab' },
  resourcemanager: { 'principal' => 'rm',
                     'keytab' => 'rm.service.keytab',
                     'owner' => 'yarn',
                     'princhost' => '_HOST',
                     'perms' => '0600',
                     'spnego_keytab' => 'rm.service.keytab' },
  nodemanager: { 'principal' => 'nm',
                 'keytab' => 'nm.service.keytab',
                 'owner' => 'yarn',
                 'princhost' => '_HOST',
                 'perms' => '0600',
                 'spnego_keytab' => 'nm.service.keytab' },
  historyserver: { 'principal' => 'jhs',
                   'keytab' => 'jhs.service.keytab',
                   'owner' => 'mapred',
                   'princhost' => '_HOST',
                   'perms' => '0600',
                   'spnego_keytab' => 'jhs.service.keytab' },
  spnego: { 'principal' => 'HTTP',
            'keytab' => 'spnego.service.keytab',
            'owner' => 'hdfs',
            'princhost' => '_HOST',
            'perms' => '0600',
            'spnego_keytab' => 'spnego.service.keytab' },
  zookeeper: { 'principal' => 'zookeeper',
