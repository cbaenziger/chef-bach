...
default['bcpc']['hadoop']['cluster-name'] = node.chef_environment
default['bcpc']['hadoop']['yarn']['cluster-name'] = node['bcpc']['hadoop']['cluster-name']
...
default['bcpc']['hadoop']['hdfs']['cluster-name'] = node['bcpc']['hadoop']['cluster-name']
default['bcpc']['hadoop']['hdfs_url'] = "hdfs://#{node['bcpc']['hadoop']['hdfs']['cluster-name']}/"
